      ...
      <section className="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-10">
        <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
          <div>
            ...
            <h1 className="mt-3 text-3xl font-bold sm:text-4xl">Товари</h1>
            <p className="mt-3 text-slate-400">У базі: {products.length}</p>
          </div>
          <Link
            href="/admin/products/new"
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-6 py-4 font-semibold hover:bg-blue-500 sm:w-auto"
          >
            <PackagePlus size={20} />
            Додати товар
          </Link>
        ...
        {products.length > 0 && (
          <div className="mt-8 overflow-hidden rounded-2xl border border-white/10 bg-[#111827] sm:mt-10 sm:rounded-3xl">
            <div className="divide-y divide-white/10">
              {products.map((product) => (
                <article
                  key={product.id}
                  className="grid grid-cols-[72px_minmax(0,1fr)] gap-4 px-4 py-4 lg:grid-cols-[80px_1fr_170px_140px_220px] lg:items-center lg:gap-5 lg:px-6 lg:py-5"
                >
                  <div className="flex h-18 w-18 items-center justify-center overflow-hidden rounded-xl bg-white lg:h-20 lg:w-20">
                    {product.image_url ? (
                  ...
                  <div className="min-w-0">
                    ...
                    <h2 className="mt-3 break-words text-base font-bold sm:text-lg">{product.title}</h2>
                  ...
                  <div className="col-span-2 rounded-xl border border-white/10 bg-[#0b1220] p-3 lg:col-span-1 lg:rounded-none lg:border-0 lg:bg-transparent lg:p-0">
                      <p
                  ...
                  <span
                    className={`col-span-2 w-fit rounded-full px-3 py-1 text-xs font-semibold lg:col-span-1 ${
                  ...
                  <div className="col-span-2 grid grid-cols-2 gap-2 lg:col-span-1 lg:flex lg:flex-wrap">
                    <Link
                      href={`/admin/products/${product.id}/edit`}
                      className="inline-flex h-11 items-center justify-center gap-2 rounded-xl border border-white/10 px-3 text-sm font-semibold text-slate-300 hover:bg-blue-500/10 lg:px-4"
                    >
                      <Edit3 size={17} />
                      Редагувати
                    </Link>
